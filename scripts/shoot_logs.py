...
if __name__ == '__main__':
    ...
    parser.add_argument("-o","--one",
                        help="shoot just one log",
                        action="store_true")
    parser.add_argument("-s","--sample",
                        help="keep shooting logs",
                        action="store_true")
    ...
    # Perform actions
    if a.one:
        sys.stderr.write(" [INFO] Just shooting one log out.\n") 
        args['one'] = True
    
    if a.sample:
        sys.stderr.write(" [INFO] Going to shoot logs forever.\n") 
        args['sample'] = True
